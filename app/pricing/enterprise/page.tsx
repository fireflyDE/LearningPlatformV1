    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center py-12 px-4 md:px-16">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="text-black">
          <h1 className="text-3xl font-semibold mb-2">Thank you Choosing</h1>
          <h2 className="text-3xl font-bold mb-4">The Enterprise Plan</h2>
          <div className="mb-4">
              <Image
          ...
          <div className="text-3xl font-bold mb-2">₹1,599 <span className="text-base font-normal text-gray-500">monthly</span></div>
          ...
          <ul className="space-y-2 text-sm mt-6">
            ...
            <li>✔ 5 GB Cloud Storage per User (Expandable)</li>
            <li>✔ Priority Support</li>
            <li>✔ Exclusive Community Access</li>
            <li>✔ Bulk Enrollment & License Management</li>
            <li>✔ Onboarding & Employee Dev Programs</li>
            <li>✔ SSO Support (Easy employee access)</li>
