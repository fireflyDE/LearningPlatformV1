    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center py-12 px-4 md:px-16">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="text-black">
          <span className="inline-block bg-gray-200 text-xs font-medium px-3 py-1 rounded-full mb-2">Best Value</span>
          <h1 className="text-3xl font-semibold mb-2">Thank you for Choosing</h1>
          <h2 className="text-3xl font-bold mb-4">The Pro Plan</h2>
          <div className="mb-4">
              <Image
          ...
          <div className="text-3xl font-bold mb-2">₹1,399 <span className="text-base font-normal text-gray-500">monthly</span></div>
        ...
        {/* RIGHT - Payment Form (reused structure) */}
        <Card className="w-[415px] h-[752px] shadow-lg border p-6 flex flex-col justify-between mx-auto">
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="border rounded-lg p-2 flex items-center justify-center bg-gray-100">[Card Icon]</div>
              <div className="border rounded-lg p-2 flex items-center justify-center bg-gray-100">[Paypal Icon]</div>
              <div className="border rounded-lg p-2 flex items-center justify-center bg-gray-100">[UPI Icon]</div>
            </div>
